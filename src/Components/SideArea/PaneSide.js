...
function PaneSide() {
  ...
  return (
    <>
      <div className="PaneSide-container">
        <button className="Button-container">
          <div className="Archived-icon">{svgArchived}</div>
          <div className="Archived-title">Archivados</div>
          <div className="Archived-count">2</div>
        </button>
